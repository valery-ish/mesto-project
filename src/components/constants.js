...
export const buttonSubmitChangeProfile = profilePopup.querySelector('.modal__save-btn');
export const buttonSubmitChangeAvatar = profileAvatarPopup.querySelector('.modal__save-btn');
export const profileAvatar = document.querySelector('.profile__avatar');
export const profileAvatarSrc = profileAvatarPopup.querySelector('#profile-avatar-link');
